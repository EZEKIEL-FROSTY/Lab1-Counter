...
VL_INLINE_OPT void Vcounter___024root___sequent__TOP__0(Vcounter___024root* vlSelf) {
    ...
    // Body
    vlSelf->top__DOT____Vcellout__myCounter__count 
        = ((IData)(vlSelf->rst) ? 0ULL : ((IData)(vlSelf->en)
                                           ? (vlSelf->top__DOT____Vcellout__myCounter__count 
                                              + (QData)((IData)(vlSelf->en)))
                                           : (vlSelf->top__DOT____Vcellout__myCounter__count 
                                              - 1ULL)));
    ...
    vlSelf->top__DOT__myDecoder__DOT__result = ((0xfff00U 
                                                ...
                                                | (0xffU 
                                                   & (IData)(vlSelf->top__DOT____Vcellout__myCounter__count)));
